        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        <a href="addproductcategory.php" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img"
                                class="me-1">Add New Product Category</a>
                    </div>
                </div>
                                ...
                                <tbody>
                                   ...
                                   function fetch_product_category(){
                                    ...
                                    return $result;
                                        ...
                                        $resault = fetch_product_category();
                                        if ($resault) {
